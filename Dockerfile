...
CMD ["sh", "-lc", "node openclaw.mjs config set gateway.controlUi.allowedOrigins '[\"https://openclaw-0322.onrender.com\"]' --strict-json && exec node openclaw.mjs gateway --allow-unconfigured --bind=lan"]
